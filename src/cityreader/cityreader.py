...
def cityreader_stretch(lat1, lon1, lat2, lon2, cities=[]):
    ...
    try:
        def sort_values(a, b):
            biggest.append(a) if a > b else smallest.append(a)
            smallest.append(b) if b < a else biggest.append(b)

        sort_values(user_input[0], user_input[2])
        sort_values(user_input[1], user_input[3])
