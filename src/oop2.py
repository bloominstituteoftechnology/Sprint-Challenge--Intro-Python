...
honda = GroundVehicle()
rik = GroundVehicle(3)
print(honda.num_wheels) # Print 4 when no wheels specified
print(rik.num_wheels) # Prints 3 when wheels are specified
...
cbr = Motorcycle()
print(cbr.num_wheels) # Print 2 automatically
