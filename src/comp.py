...
print("Ends with e:")
r = [person.name for person in humans if person.name[len(person.name) -1] == 'e']  # TODO
print(r)
...
r = [person.name for person in humans if person.name[0] >= 'C' and person.name[0] <= 'G']  # TODO
print(r)
