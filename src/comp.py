...
r = [human.name for human in humans if human.name[0] == 'C' or human.name[0] == 'D' or human.name[0] == 'E' or human.name[0] == 'F' or human.name[0] == 'G']  # TODO
print(r)
...
r = [human.name + ", " + str(human.age) for human in humans if human.age <= 32 and human.age >= 27]  # TODO
print(r)
...
r = [human.name.upper() + ', ' + str(human.age + 5) for human in humans]  # TODO
print(r)
