...
print("Starts with D:")
r = [each for each in humans if each.name[0] == 'D']  # TODO: each for each method
print(r)
...
r = [list(map(lambda x: Human(x.name.upper(), x.age+5), humans))]  # TODO: lambda allows liast to map out a list of funcitons 
print(r)
