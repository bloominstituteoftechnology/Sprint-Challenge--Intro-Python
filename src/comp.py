...
r = [human for human in humans if (
    human.name[0] in ['C', 'D', 'E', 'F', 'G'])]  # TODO
print(r)
...
r = [human.name.upper() for human in humans] + \
    [human.age+5 for human in humans]  # TODO
print(r)

# Write a list comprehension that contains the square root of all the ages.
print("Square root of ages:")
r = [human.age ** (1/2.0) for human in humans]  # TODO
print(r)
