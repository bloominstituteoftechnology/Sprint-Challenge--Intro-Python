...
print("Starts with D:")
r = [human for human in humans if "D" == human.name[0]]  # TODO
print(r)
...
print("Ends with e:")
r = [human for human in humans if "e" == human.name[-1]]  # TODO
print(r)
...
r = [human for human in humans if human.name[0] in "CDEFG"]  # TODO
print(r)
