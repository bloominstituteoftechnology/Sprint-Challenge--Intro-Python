...
r = [human.name for human in humans if human.name[0] >= 'C' and human.name[0] <= 'G']  # TODO
print(r)
...
r = [tuple((human.name, human.age) for human in humans if human.age >= 27 and human.age <= 32)]  # TODO
print(r)
...
r = [Human(human.name.upper(), human.age + 10) for human in humans]  # TODO
print(r)

# Write a list comprehension that contains the square root of all the ages.
print("\nSquare root of ages:")
r = [human.age ** 2 for human in humans]  # TODO
print(r)