...
# Write a list comprehension that creates a list of names of everyone
# whose name starts with any human between 'C' and 'G' inclusive.

print("Starts between C and G, inclusive:")
r = [human for human in humans if human.name[0] >="C" and human.name[0] <="G"]  # TODO
print(r)
...
r = ['-'.join([human.name,str(human.age)]) for human in humans]  # TODO
print(r)
...
r = [human for human in humans if human.age >=27 and human.age <= 32]  # TODO
print(r)
