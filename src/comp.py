...
# r = [i for i in humans if i.name[0]==('D')]  # TODO (v2) --> [<Human: Daphne, 30>, <Human: David, 31>]
# for i in humans:
...
# r = [i.name for i in humans if i.name.endswith('e')]  # TODO
print(r)
...
r = [i for i in humans if i.name[0] >= 'C' and i.name[0] <= 'G']  # TODO
print(r)
...
r = [i for i in humans if i.age in range(27, 33) ]  # TODO
print(r)
