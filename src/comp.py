...
import re
import string
pattern = re.compile(r'\[C-G]')
print("Starts between C and G, inclusive:")
r = [h.name for h in humans if h.name[0] in string.ascii_uppercase[2:7]]  # TODO
print(r)
...
r = [Human(h.name, h.age + 5) for h in humans]  # TODO
print(r)

# Write a list comprehension that contains the square root of all the ages.
print("Square root of ages:")
r = [h.age**(1/2) for h in humans]  # TODO
print(r)