...
query = alphabet[2:7]
r = [h.name for h in humans if h.name[0] in query]  # TODO
print(r)
...
r = [(h.name, h.age) for h in humans if h.age in range(27,32)]  # TODO
print(r)
...
r = [(h.name.upper(), h.age+5) for h in humans]  # TODO
print(r)

# Write a list comprehension that contains the square root of all the ages.
print("Square root of ages:")
r = [h.age**0.5 for h in humans]  # TODO
print(r)