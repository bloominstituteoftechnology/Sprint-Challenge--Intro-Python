...
print("Starts with D:")
r = [capD for capD in humans if capD.name[0] == 'D']  # TODO
print(r)
...
print("Ends with e:")
r = [endsE for endsE in humans if endsE.name[-1] == 'e']  # TODO
print(r)
...
r = [startsC for startsC in humans if startsC.name[0] >= 'C' and startsC.name[0] <= 'G']  # TODO
print(r)

# Write a list comprehension that creates a list of all the ages plus 10.
print("Ages plus 10:")
r = [plusTen.age + 10 for plusTen in humans ]  # TODO
print(r)
