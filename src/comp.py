...
print("Starts with D:")
r = [human.name for human in humans if human.name[0] is 'D']  # TODO
print(r)
...
print("Ends with e:")
r = [human.name for human in humans if human.name[len(human.name)-1] is 'e']  # TODO
print(r)
...
r = [human.name for human in humans if human.name[0] in ['C', 'D', 'E', 'F', 'G']]  # TODO
print(r)
