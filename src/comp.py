...
r = [human.name for human in humans if human.name[0] == 'D' or human.name[0] == 'D' or human.name[0] == 'E' or human.name[0] == 'F' or human.name[0] == 'G']  # TODO
print(r)
...
r = [tuple([human.name, human.age]) for human in humans if human.age in range(27, 33)] # TODO
print(r)
