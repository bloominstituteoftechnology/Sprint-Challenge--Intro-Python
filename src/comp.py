...
print("Starts with D:")
r = [h.name for h in humans if h.name[0].lower() == "d"]
print(r)
...
print("Ends with e:")
r = [h.name for h in humans if h.name[-1].lower() == "e"]  # TODO
print(r)
...
letters = "cdefg"
r = [h.name for h in humans if [True for l in letters if h.name[0].lower() == l]]  # TODO
print(r)
