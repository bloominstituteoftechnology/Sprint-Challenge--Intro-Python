...
r = [human.name for human in humans if re.match(regex, human.name[0])]  # TODO
print(r)
...
r = ["{}-{}".format(human.name,human.age) for human in humans if human.name.startswith("D")]  # TODO
print(r)
...
r = ["({}, {})".format(human.name,human.age) for human in humans if human.name.startswith("D") if 27<=human.age<=32]  # TODO
print(r)
