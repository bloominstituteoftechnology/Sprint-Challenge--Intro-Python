...
r = [human.name for human in humans if human.name[0] in string.ascii_uppercase[2:7]]
print(r)
...
# Note: all the names are already capitalized, I assume
# it mean to make all the letters in the name uppercase
