...
r = [human for human in humans if (human.name[0] == 'D' or human.name[0] == 'E' or human.name == 'F')]  # TODO
print(r)
...
r = [(human.name, str(human.age)) for human in humans if (human.age > 27 and human.age < 32)]  # TODO
print(r)
