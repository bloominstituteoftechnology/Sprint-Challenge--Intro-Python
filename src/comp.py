...
print("Ends with e:")
r = [potatosalad for potatosalad in humans if potatosalad.name[-1] == 'e']  # TODO
print(r)
...
r = [potatosalad.name for potatosalad in humans if potatosalad.name[0] >= 'C' and potatosalad.name <= 'G']  # TODO
print(r)

# Write a list comprehension that creates a list of all the ages plus 10.
print("Ages plus 10:")
r = [potatosalad.age + 10 for potatosalad in humans]  # TODO
print(r)
