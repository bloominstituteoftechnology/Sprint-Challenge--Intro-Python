...
r = [human.name for human in humans if human.name[0] == ("C", "D", "E", "F", "G")]  # TODO
print(r)
...
r = ["_".join(human.name, str(human.age)) for human in humans]  # TODO
print(r)
...
r = [math.sqrt(each.age) for each in humans]  # TODO
print(r)
