...
r = [Human.name for Human in humans if ord(Human.name[0]) in range(ord('C'), ord('G')+1)]  # TODO
print(r)
...
r = [(Human.name, Human.age) for Human in humans if Human.age in range(27, 32+1)]  # TODO
print(r)
