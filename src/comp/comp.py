...
c = [x.name for x in humans if x.name[0] in range(ord('C'), ord('G')+1)]
print(c)
...
f = ["(" + x.name + ", " + str(x.age) + ")" for x in humans  for x.age in range(27,32)]
print(f)
...
g = ["Human('" + x.name.upper() + "', " + str((x.age + 5)) + ")" for x in humans]
print(g)
