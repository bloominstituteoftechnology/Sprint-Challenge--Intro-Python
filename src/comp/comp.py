...
print(b)
# PERSONAL NOTES ============ could obviously use startswith method on the first one, also may be best to change all characters to lowercase or upper so that casing does not interfere with results when selecting by character
