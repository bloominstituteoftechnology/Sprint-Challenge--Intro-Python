...
class Human:
    def __init__(self, name, age):
        self.name = name
        self.age = age
    # __repr__() function returns the object representation
    def __repr__(self):
...
f = [(human.age, human.name) for human in humans if 27 <= human.age <= 32]
print(f)
...
newliast = []
g = [Human(human.name.capitalize(), human.age + 5) for human in humans]
print(g)
print(humans)
