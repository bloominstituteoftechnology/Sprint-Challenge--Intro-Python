...
#not dry go through and fix this after sprint
#Maybe this
#prefixes = ('C', 'D', 'E', 'F', 'G')
#c = [human.name for human in humans if human.name.startswith(prefixes)]
...
#need to use str for age bc cannot concatentate str&int, making int into string
print(e)
