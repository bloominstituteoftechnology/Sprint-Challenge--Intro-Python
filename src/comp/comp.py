...
print("Starts with D:")
a = [person.name for person in humans if person.name[:1] == 'D']
print(a)
...
c = [person.name for person in humans if person.name[:1] in ['C', 'D', 'E', 'F', 'G']]
print(c)
...
e = [str(person.name) + '-' + str(person.age) for person in humans]
print(e)
