...
char_list = ['C', 'D', 'E', 'F', 'G']
c = [person.name for person in humans if person.name[0] in char_list]
print(c)
...
g = [(Human((person.name).upper(), person.age + 5)) for person in humans if person.age >=27 or person.age <=32]
print(g)
