...
print("Starts with D:")
a = [human.name for human in humans if (human.name[0] in 'D')]
print(a)

# Write a list comprehension that creates a list of names of everyone
# whose name ends in "e".
print("Ends with e:")
b = [human.name for human in humans if (human.name[-1] in 'e')]
print(b)
...
# res = [x + K for x in test_list] (for each number, add 10, repeat cycle)
# Write a list comprehension that creates a list of all the ages plus 10.
print("Ages plus 10:")
d = [human.age + 10 for human in humans]
print(d)

# everything in f string literal is combined
