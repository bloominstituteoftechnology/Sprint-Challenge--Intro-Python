...
c = [i.name for i in humans if i.name[0] == 'C' or i.name[0] ==
     'D' or i.name[0] == 'E' or i.name[0] == 'F' or i.name[0] == 'G']  # there's got to be a drier way to do this
print(c)
...
# stringify age to be able to concatenate
...
# end of range needs to be one higher to be inclusive
