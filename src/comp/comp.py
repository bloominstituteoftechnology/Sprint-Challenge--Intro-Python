...
# c = [i.name for i in humans if i.name[0] == 'D' elif i.name[0] == 'G']
# c = [i.name if i.name[0] == 'D' and i.name[0] == 'G' else "" for i in humans]
alphabet = ['C','D','E','F','G']
c = [i.name for i in humans if i.name[0] in alphabet]
print(c)
