...
#     if humanName.name[:1]=="D":
#         a.append(humanName.name)


# ----Efficeint way-----

a=[humanName.name for humanName in humans if humanName.name[:1]=="D"]
...
print("Ends with e:")
b = []
b=[humanName.name for humanName in humans if humanName.name[-1:]=="e"]
...
w=["C","D","E","F","G"]
# for humanName in humans:
#     if humanName.name[:1] in w:
#         c.append(humanName.name)
c=[humanName.name for humanName in humans if humanName.name[:1] in w ]
