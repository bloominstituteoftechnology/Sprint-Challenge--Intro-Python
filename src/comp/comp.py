...
print("Starts with D:")
a = [human.name for human in humans if re.search(r"^D", human.name)]
print(a)

# Write a list comprehension that creates a list of names of everyone
# whose name ends in "e".
print("Ends with e:")
b = [human.name for human in humans if re.search(r"e$", human.name)]
print(b)

# Write a list comprehension that creates a list of names of everyone
# whose name starts with any letter between 'C' and 'G' inclusive.
print("Starts between C and G, inclusive:")
c = [human.name for human in humans if re.search(r"^[C-G]", human.name)]
print(c)
