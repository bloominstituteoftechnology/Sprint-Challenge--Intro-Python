...
print("Starts with D:")
a = [human.name for human in humans if human.name[0] == 'D' or human.name[0] == 'd']
print(a)

# Write a list comprehension that creates a list of names of everyone
# whose name ends in "e".
print("Ends with e:")
b = [human.name for human in humans if human.name[-1] == 'E' or human.name[-1] == 'e']
print(b)

# Write a list comprehension that creates a list of names of everyone
# whose name starts with any letter between 'C' and 'G' inclusive.
print("Starts between C and G, inclusive:")
c = [human.name for human in humans if 'C' <= human.name[0] <= 'G' or 'c' <= human.name[0] <= 'g']
print(c)
