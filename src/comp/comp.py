...
c = [str(h.name) for h in humans if h.name[0].lower() in ['c', 'd', 'e', 'f', 'g']]
print(c)

# Write a list comprehension that creates a list of all the ages plus 10.
print("Ages plus 10:")
d = [name.age + 10 for name in humans]  ##h.age > 10 for h in humans works as well but just prints true/false miss read the question i thought it meant people over 10 
print(d)
