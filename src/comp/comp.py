...
# Write a list comprehension that creates a list of tuples containing name and age,
# for example ("David", 31), for everyone between the ages of 27 and 32, inclusive.
