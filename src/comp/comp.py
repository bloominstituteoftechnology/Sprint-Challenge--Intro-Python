...
print("Starts with D:")
a = [f.name for f in humans if f.name.startswith('D')] #four loop list comp
print(a)

# Write a list comprehension that creates a list of names of everyone
# whose name ends in "e".
print("Ends with e:")
b = [f.name for f in humans if f.name.endswith("e")]
print(b)
...
print("Ages plus 10:")
d = [f.age + 10 for f in humans]
print(d)

# Write a list comprehension that creates a list of strings which are the name
# joined to the age with a hyphen, for example "David-31", for all humans.
print("Name hyphen age:")
e = [f'{f.name}-{f.age}' for f in humans]
print(e)
...
g = [Human(f.name.upper(), f.age + 5) for f in humans]
print(g)
